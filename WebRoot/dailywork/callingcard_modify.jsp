...
function myAdd()
{
	if (checkit())
	{
		document.forms[0].action = "changeCardClient";
...
<table  cellSpacing=1 cellPadding=2 class="table2">
  <tr>
    ...
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">    
    	<s:select list="cardTeamList" listValue="name" listKey="name" name="cardclient.team" theme="simple"></s:select>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">    
    	<s:textfield name="cardclient.client_name" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">单位</th>
   <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">    
    	<s:textfield name="cardclient.work" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">职务</th>
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">   
    	<s:textfield name="cardclient.work_post" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">移动电话</th>
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">
    	<s:textfield name="cardclient.mobile_phone" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">单位电话</th>
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
    <s:textfield name="cardclient.work_phone" theme="simple"></s:textfield>
  ...
  <tr>
    ...
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">
    	<s:textfield name="cardclient.work_fax" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">EMAIL</th>
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
    	<s:textfield name="cardclient.email" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">单位地址</th>
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">
    	<s:textfield name="cardclient.work_address" theme="simple"></s:textfield>
    </td>
  </tr>
<s:hidden name="cardclient.id"></s:hidden>
