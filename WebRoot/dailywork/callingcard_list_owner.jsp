...
<SCRIPT language="JavaScript">
  ...
  function query(){
            ...
            var query_work=document.getElementById('query_work').value;
 			window.location.href='queryCardClientOwner?name='+query_name+'&teamname='+query_team+'&workname='+query_work;
             }
</SCRIPT>
</head>
<body class="body0">
	...
	<table class="table_path">
		<tr>
		<td >您当前的位置：<a href="#"><span class="txtpath">日常办公</span></a> &gt; <a href="#"><span class="txtpath">名片夹</span></a> &gt; 个人名片列表</td>
		<td align="right" >
	      <script language=JavaScript>
										 today=new Date();
										 function initArray(){
...
<input type="button" class=btn_mouseout onmousedown="this.className='btn_mousedown'" onmouseup="this.className='btn_mouseup'" onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" onclick="window.location.href='query_callingcard_list_owner'" value="查询全部">
</p>            </td>
          </tr>
        </table>
  <table  cellSpacing=1 cellPadding=2 class="table1" id="table4">
	    ...
	    <th scope="col"><div align="center">操作</div></th>
          ...
          <tr class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">
            ...
            <td><div align="center">
              	<s:url id="get" action="getCardClientOwner">
                	<s:param name="id">${id}</s:param>
       </s:url>
       <s:a href="%{get}"><img src="images/btn_edit.gif" style="cursor: hand;" alt='修改'"></s:a>
  
            <s:url id="del" action="delCardClientOwner">
	<s:param name="id">${id}</s:param>
       </s:url>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table0">
  <tr>
    ...
    <td  width="35%">
    	<input name="button" type="button" class=btn_mouseout onmousedown="this.className='btn_mousedown'" onmouseup="this.className='btn_mouseup'" onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" value="新建名片" onClick="location.href='callingcard_add_owner'">
    	<input name="button" type="button" class=btn_mouseout onmousedown="this.className='btn_mousedown'" onmouseup="this.className='btn_mouseup'" onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" value="维护分组" onClick="location.href='query_callingcard_team_owner'">
    </td>
  <td width="62%">
