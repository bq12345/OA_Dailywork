...
<body class="body0">
	...
	<table class="table_path">
		<tr>
		<td >您当前的位置：<a href="#"><span class="txtpath">日常办公</span></a> &gt; <a href="#"><span class="txtpath">名片夹</span></a> &gt; 公共分组列表</td>
		<td align="right" >
	      <script language=JavaScript>
										 today=new Date();
										 function initArray(){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table0">
  <tr>
    ...
    <td  width="35%"><input name="button" type="button" class=btn_mouseout onmousedown="this.className='btn_mousedown'" onmouseup="this.className='btn_mouseup'" onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" value="增加组" onClick="location.href='dailywork/callingcard_add_group.jsp'">
