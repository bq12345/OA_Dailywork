...
function myAdd()
{
	if (checkit())
	{
	document.forms[0].action = "changeCardTeamOwner";
...
function myModify()
{
	if (checkit())
	{
		document.forms[0].action = "callingcard_list_group.htm";
		document.forms[0].submit();
	}
}
...
<table  cellSpacing=1 cellPadding=2 class="table2">
  <tr>
    ...
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">    
    	<s:textfield name="cardteamowner.name" theme="simple"></s:textfield>
    </td>
  </tr>
  <tr>
    <th scope="row">备注</th>
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
    	<s:textarea name="cardteamowner.remark" theme="simple"></s:textarea>
    </td>
  </tr>
</table>
<s:hidden name="cardteamowner.id"></s:hidden>
