...
document.forms[0].action = "addType";
...
function myModify()
{
    ...
    document.forms[0].name.value = res;
	document.forms[0].action = "policytypeAction.do?method=modifypolicytype";
	document.forms[0].submit();
}	
...
<form name="policytypeForm" method="POST" action="/yl/system/policytypeAction.do?method=addpolicytype">
