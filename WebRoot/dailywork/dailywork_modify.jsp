...
<form name="statuteFileForm" method="post" action="changeDailywork" onsubmit="return subchoose();">
...
<table class="table2">
				...
				<tr>
					<th scope="row">主题</th>
					<td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
					<s:textfield name="dailywork.topic"  theme="simple"></s:textfield>
					</td>
				</tr>
				<tr>
					<th scope="row">内容</th>
			...
			<s:hidden name="dailywork.id"></s:hidden>
			<s:hidden name="dailywork.standard"></s:hidden>
