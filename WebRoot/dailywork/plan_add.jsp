...
<form name="statuteFileForm" method="post" action="addPlan" onsubmit="return subchoose();">
...
<tr>
		...
		<td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
					<input type="text" name="plan.name" value=""></td>
				</tr>
				<tr>
					<th scope="row">计划执行人</th>
		<td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
					<input type="text" name="plan.person" value=""></td>
				</tr>
				<tr>
					<th scope="row">开始日期</th>
				  <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">
					<input type="date" name="plan.start_date">
      </tr>
				<tr>
					<th scope="row">结束时间</th>
					<td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">					<div align="left"><span class="tr_s">
					  <input type="date" name="plan.end_date">
					</td>
				</tr>				
				...
				<tr>
					<th scope="row">内容</th>
					<td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">
                      <textarea name="plan.data" cols="60" rows="10"></textarea>
</td>
				</tr>
