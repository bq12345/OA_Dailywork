...
function myAdd()
{
	if (checkit())
	{
		document.forms[0].action = "addCardClientOwnerDo";
...
<div align="center">
	<table class="table_path">
		...
		<tr>
			<td >您当前的位置：<a href="#"><span class="txtpath">日常办公</span></a> &gt; <a href="#"><span class="txtpath">名片夹</span></a> &gt; 个人名片夹维护</td>
		    <td align="right" >
	      <script language=JavaScript>
										 today=new Date();
										 function initArray(){
...
<table  cellSpacing=1 cellPadding=2 class="table2">
  <tr>
    ...
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">    
    	<s:select list="list" listValue="name" listKey="name" name="cardclientowner.team" theme="simple"></s:select>
    </td>
  </tr>
