...
function myAdd()
{
	if (checkit())
	{
		document.forms[0].action = "AddCardTeam";
...
<div align="center">
	<table class="table_path">
		<tr>
			<td >您当前的位置：<a href="#"><span class="txtpath">日常办公</span></a> &gt; <a href="#"><span class="txtpath">名片夹</span></a> &gt; 公共名片夹分组维护</td>
		    <td align="right" >
	      <script language=JavaScript>
										 today=new Date();
										 function initArray(){
...
<table  cellSpacing=1 cellPadding=2 class="table2">
  <tr>
    ...
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">    
    	<input type="text" name="cardteam.name" value="">
    </td>
  </tr>
  <tr>
    <th scope="row">备注</th>
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
    	<textarea name="cardteam.remark"></textarea>
    </td>
  </tr>
  <s:hidden name="cardteam.id" theme="simple"></s:hidden>
  <s:hidden name="cardteam.num" theme="simple"></s:hidden>
</table>
