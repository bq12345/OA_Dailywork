...
function myAdd()
{
	if (checkit())
	{
		document.forms[0].action = "AddCardTeamOwner";
...
function myModify()
{
	if (checkit())
	{
		document.forms[0].action = "callingcard_list_group_owner.htm";
		document.forms[0].submit();
	}
}
...
<div align="center">
	<table class="table_path">
		<tr>
			<td >您当前的位置：<a href="#"><span class="txtpath">日常办公</span></a> &gt; <a href="#"><span class="txtpath">名片夹</span></a> &gt; 个人名片夹分组维护</td>
		    <td align="right" >
	      <script language=JavaScript>
										 today=new Date();
										 function initArray(){
...
<table  cellSpacing=1 cellPadding=2 class="table2">
  <tr>
    ...
    <td class="tr_s" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_s'">    
    	<input type="text" name="cardteamowner.name" value="">
    </td>
  </tr>
  <tr>
    <th scope="row">备注</th>
    <td class="tr_d" onmouseover="this.className='tr_o'" onmouseout="this.className='tr_d'">
    	<textarea name="cardteamowner.remark"></textarea>
    </td>
  </tr>
  <s:hidden name="cardteamowner.id" theme="simple"></s:hidden>
  <s:hidden name="cardteamowner.num" theme="simple"></s:hidden>
</table>
